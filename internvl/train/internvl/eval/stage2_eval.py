...
from internvl.model.internvl_chat_eval2 import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig,
                                          InternVLChatModel)
...
def save_and_evaluate(data_list, output_file='results.csv'):
...
def main():
    ...
    for item2 in train_dataloader:
        ...
        data_list.append([video_name, answer, output, mos_score, score1, level])

    # Save results to CSV and calculate SRCC, PLCC, KRCC
    save_and_evaluate(data_list, output_file="mos3_test_stage2-9600.csv")
